...
3)));
			...
			allOf(withId(R.id.buttonRoom), withText("Room"),
...
isDisplayed()));
		...
		ViewInteraction appCompatButton3 = onView(
			...
			allOf(withId(R.id.buttonAvailable), withText("Available Rooms"),
...
0),isDisplayed()));
		...
		ViewInteraction appCompatButton4 = onView(
			...
			allOf(withId(R.id.buttonAll), withText("All Rooms"),
...
isDisplayed()));
		...
		ViewInteraction appCompatButton5 = onView(
			...
			allOf(withId(R.id.buttonRate), withText("Set Room Rate"),
                        
				childAtPosition(
    
					childAtPosition(
                                        
						withClassName(is("android.widget.RelativeLayout")),1),
2),isDisplayed()));
