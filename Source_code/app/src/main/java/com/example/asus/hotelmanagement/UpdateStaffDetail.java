...
public class UpdateStaffDetail extends AppCompatActivity {
    ...
    public class DoSearch extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String z) {
            ...
            Toast.makeText(UpdateStaffDetail.this, z, Toast.LENGTH_SHORT).show();
            if (isSuccess) {
                Intent intent = new Intent(UpdateStaffDetail.this,UpdateStaff.class);
